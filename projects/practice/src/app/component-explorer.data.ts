...
export const COMPONENT_CATEGORIES: ComponentCategory[] = [
  {
    ...
    components: [
      ...
      },
      {
        ...
        properties: [
          { name: 'heading-1', type: 'CSS class', default: '—', description: '32.44px · --dx-font-size-h1 · letter-spacing 0.15px' },
          { name: 'heading-2', type: 'CSS class', default: '—', description: '28.83px · --dx-font-size-h2 · letter-spacing 0px' },
          { name: 'heading-3', type: 'CSS class', default: '—', description: '25.63px · --dx-font-size-h3 · letter-spacing 0px' },
          { name: 'heading-4', type: 'CSS class', default: '—', description: '22.78px · --dx-font-size-h4 · letter-spacing 0.25px' },
          { name: 'heading-5', type: 'CSS class', default: '—', description: '20.25px · --dx-font-size-h5 · letter-spacing 0px' },
          { name: 'heading-6', type: 'CSS class', default: '—', description: '18px · --dx-font-size-h6 · letter-spacing 0.15px' },
          { name: 'body',      type: 'CSS class', default: '—', description: '16px · --dx-font-size-body · letter-spacing 0.1px' },
          { name: 'subbody',   type: 'CSS class', default: '—', description: '14px · --dx-font-size-subbody · letter-spacing 0.1px' },
          { name: 'paragraph', type: 'CSS class', default: '—', description: '12px · --dx-font-size-paragraph · letter-spacing 0.46px' },
      ...
      },
      {
        ...
        routeIsPreview: false,
        route: 'background',
        description: 'Background token explorer — surface and semantic background tokens paired with their "on-*" text color for legibility.',
        properties: [
          { name: '--dx-surface',               type: 'CSS var', default: '#ffffff', description: 'Base white surface.' },
          { name: '--dx-surface-card',           type: 'CSS var', default: '#ffffff', description: 'Card surface — typically same as surface.' },
          { name: '--dx-surface-variant',        type: 'CSS var', default: '#f3f7ff', description: 'Tinted surface for chips, hover states, code blocks.' },
          { name: '--dx-primary',                type: 'CSS var', default: '#1f3bb3', description: 'Brand primary as a background — pair with --dx-on-primary.' },
          { name: '--secondary-base',            type: 'CSS var', default: '#fe5c83', description: 'Secondary brand background — pair with --secondary-on-base.' },
          { name: '--alert-success-light',       type: 'CSS var', default: '#d4edda', description: 'Success semantic background.' },
          { name: '--alert-warning-light',       type: 'CSS var', default: '#ffe5b4', description: 'Warning semantic background.' },
          { name: '--alert-error-light',         type: 'CSS var', default: '#f8d7da', description: 'Error semantic background.' },
          { name: '--alert-information-light',   type: 'CSS var', default: '#d6e4ff', description: 'Informational semantic background.' },
        ],
      },
      {
        name: 'Text',
        ...
        routeIsPreview: false,
        route: 'text',
        description: 'Text color and type-scale explorer — all palette text tokens applied across every size level with interactive color and weight controls.',
        properties: [
          { name: '--dx-on-surface',         type: 'CSS var', default: '#2f2f2f', description: 'Primary text — used for headings and high-emphasis body copy.' },
          { name: '--dx-on-surface-variant', type: 'CSS var', default: '#667085', description: 'Muted / secondary text — captions and supporting copy.' },
          { name: '--dx-primary',            type: 'CSS var', default: '#1f3bb3', description: 'Brand text — links and interactive labels.' },
          { name: '--dx-error',              type: 'CSS var', default: '#bd3232', description: 'Error text — validation messages and destructive labels.' },
          { name: '--alert-success',         type: 'CSS var', default: '#28a745', description: 'Success text.' },
          { name: '--alert-warning',         type: 'CSS var', default: '#ffa500', description: 'Warning text.' },
          { name: '--alert-information',     type: 'CSS var', default: '#007bff', description: 'Informational text.' },
          { name: '--dx-font-size-h1 … --dx-font-size-paragraph', type: 'CSS var', default: '32.44px → 12px', description: '9-step type scale: H1 / H2 / H3 / H4 / H5 / H6 / Body / SubBody / Paragraph.' },
        ],
      },
      {
        name: 'Padding & Margin',
