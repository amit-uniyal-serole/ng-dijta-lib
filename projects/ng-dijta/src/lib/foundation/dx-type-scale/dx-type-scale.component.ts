...
export class DxTypeScaleComponent {
  ...
  readonly levels: TypeLevel[] = [
    { label: 'H1',        cssClass: 'heading-1', size: '32.44px', letterSpacing: '0.15px', lineHeight: '1', scssKey: 'h1'        },
    { label: 'H2',        cssClass: 'heading-2', size: '28.83px', letterSpacing: '0px',    lineHeight: '1', scssKey: 'h2'        },
    { label: 'H3',        cssClass: 'heading-3', size: '25.63px', letterSpacing: '0px',    lineHeight: '1', scssKey: 'h3'        },
    { label: 'H4',        cssClass: 'heading-4', size: '22.78px', letterSpacing: '0.25px', lineHeight: '1', scssKey: 'h4'        },
    { label: 'H5',        cssClass: 'heading-5', size: '20.25px', letterSpacing: '0px',    lineHeight: '1', scssKey: 'h5'        },
    { label: 'H6',        cssClass: 'heading-6', size: '18px',    letterSpacing: '0.15px', lineHeight: '1', scssKey: 'h6'        },
    { label: 'Body',      cssClass: 'body',      size: '16px',    letterSpacing: '0.1px',  lineHeight: '1', scssKey: 'body'      },
    { label: 'SubBody',   cssClass: 'subbody',   size: '14px',    letterSpacing: '0.1px',  lineHeight: '1', scssKey: 'subbody'   },
    { label: 'Paragraph', cssClass: 'paragraph', size: '12px',    letterSpacing: '0.46px', lineHeight: '1', scssKey: 'paragraph' },
  ];
