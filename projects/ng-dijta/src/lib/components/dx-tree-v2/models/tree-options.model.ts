...
const defaultActionMapping: IActionMapping | undefined | null = {
  mouse: {
...
export interface IActionMapping {
  mouse?: {
    click?: IActionHandler | undefined,
    dblClick?: IActionHandler | null,
    contextMenu?: IActionHandler | null,
...
export class TreeOptions {
  ...
  allowDrag(node: TreeNode): boolean | any {
