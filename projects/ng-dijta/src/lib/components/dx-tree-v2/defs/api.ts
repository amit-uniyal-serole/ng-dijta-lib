...
export interface ITreeNode {
   ...
   */
  ensureVisible(): any | undefined;
  /**
   * Activates / Deactivates the node (selects / deselects)
   */
  toggleActivated(multi: any): any | undefined;
  /**
   * Focus on the node
   */
  focus(): any | undefined;
   ...
   * If multi is true (default false) - does a multiselect.
   */
  setActiveAndVisible(multi: boolean): any | undefined;
}
...
export interface ITreeModel {
   ...
   */
  moveNode(node: ITreeNode, to: { parent: ITreeNode, index: number, dropOnNode: boolean }, from: { parent: ITreeNode, index: number }): any;
  /**
