...
export class PanelFactoryService {
    ...
    componentRef: ComponentRef<PanelComponent> | undefined;
    _factory: ComponentFactory<PanelComponent> | undefined;
    overlay;
    ...
    createPanel(
        ...
        this.overlay.id = "dx-colors-overlay";
        this.overlay.classList.add("dx-colors-overlay");
