...
@Directive({
    selector: "[dx-colors-trigger]",
    providers: [
        {
            provide: NG_VALUE_ACCESSOR,
            useExisting: forwardRef(() => DxColorsTriggerDirective),
            multi: true,
        },
    ],
})
export class DxColorsTriggerDirective implements ControlValueAccessor {
    ...
    @Input() palette!: Array<string> | Array<DxColorsColor>;
