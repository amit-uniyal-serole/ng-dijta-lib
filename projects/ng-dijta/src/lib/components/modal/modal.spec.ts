...
describe('dialog', () => {
  describe('basic', () => {
    ...
    it('should @input parameters default value works', fakeAsync(() => {
      debugEl.query(By.css('.dx-btn')).nativeElement.dispatchEvent(new Event('click'));
      fixture.detectChanges();
      ...
      const buttonEle = document.querySelector('.modal-footer').querySelector('.dx-btn');
      ...
      if (document.documentElement.scrollHeight > document.documentElement.clientHeight) {
        expect(body.classList).toContain('dx-body-scrollblock');
      }
    ...
    it('should @input parameters works', fakeAsync(() => {
      ...
      const buttonEle1 = button1.querySelector('.dx-btn') as HTMLElement;
      const buttonEle2 = button2.querySelector('.dx-btn') as HTMLElement;
      ...
      expect(buttonEle1.classList).toContain('dx-btn-primary');
      expect(buttonEle2.classList).toContain('dx-btn-common');
      ...
      expect(body.classList).not.toContain('dx-body-scrollblock');
