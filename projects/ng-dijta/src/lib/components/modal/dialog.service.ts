...
import { DevConfigService } from '../../utils/globalConfig';

@Injectable()
export class DialogService {
  contentRef: ComponentRef<any> | undefined;
  ...
  open({
    ...
    modalRef.instance.updateButtonOptions = (buttonOptions: any) => modalContainerRef.instance.updateButtonOptions(buttonOptions);
    ...
    modalRef.instance.onHidden = () => {
      if (modalRef.instance.documentOverFlow) {
        ...
        this.renderer.removeClass(this.document.body, 'dx-body-scrollblock');
        this.renderer.removeClass(this.document.body, 'dx-body-overflow-hidden');
