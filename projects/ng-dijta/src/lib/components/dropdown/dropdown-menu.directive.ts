...
import { AnimationCurves, AnimationDuration } from '../../core/animation/animationParameters';
...
export class DropDownMenuDirective implements OnInit, OnDestroy {
  ...
  @HostBinding('class.dx-dropdown-menu') addClass = true;
  ...
  calcPopDirection(value) {
    ...
    const bottomDistance = (this.windowRef.innerHeight ?? 0) - this.dropdown.el.nativeElement.getBoundingClientRect().bottom;
