## Selector for dx-input-icon
`<dx-input-icon></dx-input-icon>`
...
<form [formGroup]="userForm">
    <dx-input-icon (blur)="blur()"  disabled="false" formControlName="name">
            <dx-hint>
...
| **icon** (string)  | `pass icon to be displayed (default value - search)` |
