...
export class FileValidatorService {
  ...
  private uploadProgressSubject = new BehaviorSubject<boolean>(false);  

  public isUploadInprogress(value: boolean): void {
    this.uploadProgressSubject.next(value);
  }

  public getUploadingProgressData(): Observable<boolean> {
    return this.uploadProgressSubject;
  }

  private validationErrorsSub:BehaviorSubject<string[]> =new BehaviorSubject<string[]>([]);  

  public updateErrorMessageList(list: string[]): void {
    this.validationErrorsSub.next(list);
  }

  public getErrorMessageList(): Observable<string[]> {
    return this.validationErrorsSub;
  }
