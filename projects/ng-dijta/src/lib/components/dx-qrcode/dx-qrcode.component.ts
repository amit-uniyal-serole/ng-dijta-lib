...
import { DxQRCodeVersion, DxQRCodeElementType, FixMeLater } from "./types"

@Component({
  selector: "dx-qrcode",
  templateUrl: './dx-qrcode.component.html',
styleUrls: ['./dx-qrcode.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class DxQRCodeCompoent implements OnChanges {
  ...
  @Input() public elementType: DxQRCodeElementType = "canvas"
  @Input()
  ...
  @Input() public version?: DxQRCodeVersion
