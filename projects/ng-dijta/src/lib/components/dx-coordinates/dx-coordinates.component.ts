...
import { ChangeDetectorRef, Component, EventEmitter, HostBinding, Inject, Injector, Input, OnInit, Optional, Output, forwardRef } from '@angular/core';
...
@Component({
  ...
  templateUrl: './dx-coordinates.component.html',
  styleUrls: ['./dx-coordinates.component.css'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => DxCoordinatesComponent),
      multi: true
    },
    {
...
export class DxCoordinatesComponent implements OnInit, ControlValueAccessor, Validator {
  ...
  static nextId = 0;
  @HostBinding()
  id = `dx-input-coordinate-${DxCoordinatesComponent.nextId++}`;
