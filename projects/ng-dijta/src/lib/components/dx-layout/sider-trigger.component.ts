...
import { NzBreakpointKey } from '../../utils/types/breakpoint';


@Component({
  selector: '[dx-sider-trigger]',
  exportAs: 'dxSiderTrigger',
  ...
  template: `
    ...
    `,
  host: {
    '[class.dx-layout-sider-trigger]': 'isNormalTrigger',
    '[style.width]': 'isNormalTrigger ? siderWidth : null',
    '[class.dx-layout-sider-zero-width-trigger]': 'isZeroTrigger',
    '[class.dx-layout-sider-zero-width-trigger-right]': 'isZeroTrigger && nzReverseArrow',
    '[class.dx-layout-sider-zero-width-trigger-left]': 'isZeroTrigger && !nzReverseArrow'
  }
})
export class DxSiderTriggerComponent implements OnChanges, OnInit {
