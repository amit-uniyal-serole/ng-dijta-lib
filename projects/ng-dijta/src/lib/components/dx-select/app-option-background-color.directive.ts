...
@Directive({
    selector: '[appOptionBackgroundColor]'
})
export class OptionBackgroundColorDirective implements OnInit {
    @Input('appOptionBackgroundColor') backgroundColor: string | undefined;
