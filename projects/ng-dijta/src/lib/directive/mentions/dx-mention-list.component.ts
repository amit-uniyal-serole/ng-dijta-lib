import {
  Component, ElementRef, Output, EventEmitter, ViewChild, Input, TemplateRef, AfterContentChecked, OnInit
} from '@angular/core';

import { isInputOrTextAreaElement, getContentEditableCaretCoords } from './dx-mention-utils';
import { getCaretCoordinates } from './caret-coords';

@Component({
  selector: 'mention-list',
  styleUrls: ['./dx-mention-list.component.scss'],
  template: `
...
export class MentionListComponent implements AfterContentChecked,OnInit {
  ...
  private positionElement(left:number=this.coords.left, top:number=this.coords.top, dropUp:boolean=this.dropUp) {
    const el: HTMLElement | any = this.element.nativeElement;
