...
export type DxGlobalConfig = IGlobalConfig;
...
export interface dxGlobalConfig {
  ...
  global?: DxGlobalConfig;
}

export type dxGlobalConfigKey = keyof dxGlobalConfig;
export type dxGlobalInsideConfigKey = keyof dxGlobalConfig['global'];

export const dxGlobalConfigToken = new InjectionToken<dxGlobalConfig>('dx_global_config');
